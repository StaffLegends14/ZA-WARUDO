...
function preload() {
  ...
  sheet  = loadImage("assets/boat/broken_boat.png");
  CurruptedData = loadJSON("assets/boat/broken_boat.json");
...
function setup() {
  ...
  var brokenFrames = CurruptedData.frames;
  for (var i = 0; i < brokenFrames.length; i++) {
    var pos = brokenFrames[i].position;
    var img = sheet.get(pos.x, pos.y, pos.w, pos.h);
    sheetray.push(img);
  }
